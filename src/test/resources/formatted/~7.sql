SELECT DISTINCT
  ...
  AS SegmentVisitors,
  ALLIMPS.NUMIMPRESSIONS
  AS AllVisitorSegmentImpressions,
  ALLVISITORSSEGMENTCOUNT.NUMVISITORS
  AS AllVisitorsSegmentVisitors,
  TOTALIMPS.NUMIMPRESSIONS
  AS TotalImpressions,
